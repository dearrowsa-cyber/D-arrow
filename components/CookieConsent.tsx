...
export default function CookieConsent() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-[9999] bg-[#14162E] border-t border-[#FF4D6D]/30 shadow-2xl p-4 sm:p-6"
      dir={lang === "ar" ? "rtl" : "ltr"}
    >
      <div className="container mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-white text-sm sm:text-base flex-1">
          <p>
            ...
            <Link
              href="/cookies"
              className="text-[#FF4D6D] hover:underline whitespace-nowrap"
            >
              {t("cookiePolicyTitle")}
            </Link>
          </p>
