        ...
        <div className="bg-gradient-to-br from-[#14162E] via-[rgba(42, 42, 49, 0.8)] to-[rgba(11,13,31,0.9)] border border-[rgba(255,77,109,0.2)] rounded-3xl p-12 md:p-20 lg:p-24 text-center relative overflow-hidden backdrop-blur-md group hover:border-[rgba(255,77,109,0.4)] transition-all duration-300">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="inline-block bg-gradient-to-r from-[#FF4D6D] via-[#FF6F4F] to-[#FF9A3C] hover:shadow-2xl hover:shadow-[rgba(255,77,109,0.6)] !text-white px-10 py-4 rounded-lg font-bold text-base md:text-lg transition-all duration-300 shadow-lg transform hover:scale-105 active:scale-95">
                {t('getStartedToday')}
              </Link>
              <Link href="/pricing" className="inline-block border-2 border-[rgba(255,77,109,0.3)] hover:border-[rgba(255,77,109,0.7)] text-brand-white hover:text-brand-pink bg-transparent hover:bg-[rgba(255,77,109,0.1)] px-10 py-4 rounded-lg font-bold text-base md:text-lg transition-all duration-300 backdrop-blur-sm">
                {t('viewOurPricing')}
              </Link>
            </div>
          </div>
