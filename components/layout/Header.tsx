...
export default memo(function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/5"
        style={{ background: 'linear-gradient(90deg, rgba(11,13,31,0.25), rgba(20,22,46,0.35), rgba(11,13,31,0.25))', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
  ...
  <Image
    ...
    height={36}
    priority
    className="object-contain w-12 sm:w-16 md:w-20 lg:w-24 group-hover:drop-shadow-lg transition"
  />
  <span className="text-sm md:text-base lg:text-lg font-semibold pl-2 sm:pl-3 pr-2 sm:pr-4 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent whitespace-nowrap">
    {lang === 'ar' ? 'للتسويق' : 'For Marketing'}
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            <MobileNav isOpen={isMenuOpen} setIsOpen={setIsMenuOpen} lang={lang} t={t} />
          </div>
        </div>
      </div>
    </header>
