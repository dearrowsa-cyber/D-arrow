...
export default function AboutCompany() {
  ...
  return (
    <section className="relative py-8 lg:py-12 overflow-hidden border-b border-gray-800/50">
      <div className="w-full max-w-6xl mx-auto px-6 md:px-12">
        <div className={`flex flex-col lg:flex-row items-center gap-8 lg:gap-10 ${lang === 'ar' ? 'lg:flex-row-reverse' : ''}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full mb-8">
              <div className="flex flex-col gap-2">
                <div className={`flex items-center gap-2 ${lang === 'ar' ? 'flex-row-reverse' : ''}`}>
                  ...
                  <h4 className="text-white font-semibold text-sm md:text-base">{t('aboutFeature1Title')}</h4>
                </div>
                <p className="text-xs md:text-sm text-gray-400 leading-relaxed">{t('aboutFeature1Desc')}</p>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <div className={`flex items-center gap-2 ${lang === 'ar' ? 'flex-row-reverse' : ''}`}>
                  ...
                  <h4 className="text-white font-semibold text-sm md:text-base">{t('aboutFeature2Title')}</h4>
                </div>
                <p className="text-xs md:text-sm text-gray-400 leading-relaxed">{t('aboutFeature2Desc')}</p>
              </div>
            </div>
