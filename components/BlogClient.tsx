    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0e27] to-[#14162E] pt-32 pb-20">
      <div className="container mx-auto px-4 md:px-6 lg:px-12">
        ...
        <div className="mb-12 text-center" dir={lang === "ar" ? "rtl" : "ltr"}>
          ...
          <p className="text-xl text-gray-400">{t("blogSubtitle")}</p>
        </div>
        ...
        {selectedTag && (
          <div className="mb-8 flex justify-center items-center gap-4">
            <span className="text-gray-400">
              {lang === "ar" ? "تصفية حسب الوسم:" : "Filtering by tag:"}
            </span>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-12">
          {categories.map((category) => (
            ...
            >
              {category === "all" ? t("allBlogPosts") : category}
            </button>
          ))}
        </div>
        ...
        <div>
          {filteredPosts.length > 0 ? (
                    ...
                    <div>
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-slate-300 text-sm mb-4 line-clamp-3 leading-relaxed font-light">
                          {getDisplayText(post.excerpt, post.excerptAr) ||
                            stripHtml(
                              getDisplayText(post.content, post.contentAr),
                            ).substring(0, 150) + "..."}
                        </p>
                      </div>
                    </div>
            ...
            <div className="text-center py-20">
              <p className="text-xl text-gray-400">{t("blogNoPosts")}</p>
              <button
                onClick={() => {
