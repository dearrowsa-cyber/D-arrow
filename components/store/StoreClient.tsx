...
import type { StoreProduct } from "@/features/store/data";

const BADGE_GRADIENT = "from-[#FF4D6D] to-[#FF9A3C]";
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
                    setSortBy(e.target.value as "popular" | "price-asc" | "price-desc" | "rating")
                  }
                  style={{
                    backgroundColor: "#090B1B",
                    color: "#e2e8f0",
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {product.badge && (
                        <div
                          className={`absolute top-2.5 ${isAr ? "right-2.5" : "left-2.5"} px-2.5 py-0.5 rounded-full text-[10px] font-bold text-white bg-gradient-to-r ${BADGE_GRADIENT} shadow-md border border-white/20 flex items-center gap-1 backdrop-blur-md`}
                        >
            ...
            <div className="space-y-6">
              <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-slate-950 border border-white/10">
                ...
                {quickViewProduct.badge && (
                  <span
                    className={`absolute top-3 ${isAr ? "right-3" : "left-3"} px-3 py-1 rounded-full text-xs font-bold text-white bg-gradient-to-r ${BADGE_GRADIENT} shadow-lg border border-white/20 flex items-center gap-1.5`}
                  >
