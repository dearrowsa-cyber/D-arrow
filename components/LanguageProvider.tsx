...
const translations: Translations = {
  ...
  pricingBasicFeature1: { en: '8 posts/month + 4 story designs', ar: '8 منشورات شهرياً + 4 تصاميم قصص (Stories)' },
  pricingBasicFeature2: { en: 'Creative content aligned with brand identity', ar: 'كتابة محتوى إبداعي متوافق مع هوية البراند' },
  pricingBasicFeature3: { en: 'Trending hashtag research', ar: 'بحث الهاشتاجات الأكثر رواجاً' },
  pricingBasicFeature4: { en: 'Account profile setup & optimization', ar: 'ضبط وتحسين واجهة الحساب' },
  pricingBasicFeature5: { en: 'Monthly report with competitor analysis', ar: 'تقرير أداء شهري يتضمن تحليل المنافسين المباشرين' },
  
  // Pricing Card - Growth Plan
  pricingGrowth: { en: 'Growth', ar: 'النمو' },
  pricingGrowthPrice: { en: '6,399 SAR', ar: '6,399 ريال سعودي' },
  pricingGrowthFeature1: { en: '12 posts/month + full content calendar', ar: '12 منشور شهرياً + تقويم محتوى كامل' },
  pricingGrowthFeature2: { en: '4 short videos (Reels/TikTok) monthly', ar: 'إنتاج 4 فيديوهات قصيرة (Reels/TikTok) شهرياً (تصميم ومونتاج)' },
  pricingGrowthFeature3: { en: 'Engagement management (DMs & comments)', ar: 'إدارة التفاعل والرد على الرسائل والتعليقات' },
  pricingGrowthFeature4: { en: 'Ad campaigns for follower growth', ar: 'إدارة حملات إعلانية لزيادة المتابعين' },
  pricingGrowthFeature5: { en: 'Pixel & Google Analytics setup for store', ar: 'ضبط إعدادات الربط التقني (Pixel & Google Analytics) للمتجر' },
  pricingGrowthFeature6: { en: 'Basic SEO for product indexing', ar: 'تحسين أرشفة المنتجات الأساسية في محركات البحث (Basic SEO)' },
  pricingGrowthFeature7: { en: 'Detailed weekly performance report', ar: 'تقرير أداء أسبوعي مفصل' },
  pricingMostPopular: { en: 'Most Popular', ar: 'الأكثر شعبية' },
  
  // Pricing Card - Professional Plan
  pricingProfessional: { en: 'Professional', ar: 'الاحتراف' },
  pricingProfessionalPrice: { en: '7,000 SAR', ar: '7,000 ريال سعودي' },
  pricingProfessionalFeature1: { en: 'Full content management (up to 20 posts/videos monthly)', ar: 'إدارة محتوى شاملة (حتى 20 منشور/فيديو شهرياً)' },
  pricingProfessionalFeature2: { en: 'Advanced paid ads strategy (Conversion)', ar: 'استراتيجية إعلانات ممولة متقدمة (تحويل مبيعات - Conversion)' },
  pricingProfessionalFeature3: { en: 'Retargeting campaigns for store visitors', ar: 'إدارة حملات إعادة الاستهداف (Retargeting) لزوار المتجر' },
  pricingProfessionalFeature4: { en: 'Google Search Console audit & indexing fixes', ar: 'فحص فني شامل للمتجر على Google Search Console وحل مشاكل الفهرسة' },
  pricingProfessionalFeature5: { en: 'Landing page design & conversion optimization', ar: 'تصميم وتحسين صفحات الهبوط (Landing Pages) لزيادة التحويل' },
  pricingProfessionalFeature6: { en: 'A/B testing for offers & ads', ar: 'اختبار (A/B Testing) للعروض والإعلانات' },
  pricingProfessionalFeature7: { en: '2 blog articles/month for organic SEO', ar: 'كتابة 2 مقال مدونة شهرياً لتعزيز الظهور الطبيعي في جوجل' },
  ...
  pricingCustomFeature1: { en: 'Full marketing (Social Media, SEO, Email Marketing)', ar: 'تسويق شامل (سوشيال ميديا، SEO، إيميل ماركتنج)' },
  pricingCustomFeature2: { en: 'Full expansion strategy on Salla platform', ar: 'استراتيجية كاملة للتوسع في منصة "سلة" وزيادة متوسط قيمة السلة الشرائية' },
  pricingCustomFeature3: { en: 'Full Google Ads management (Search & Shopping)', ar: 'إدارة كاملة لـ Google Ads (البحث والتسوق)' },
  pricingCustomFeature4: { en: 'Dedicated account manager via WhatsApp', ar: 'مدير حساب مخصص وتواصل مباشر عبر واتساب' },
  pricingCustomFeature5: { en: 'Advanced analytics & Live Dashboard', ar: 'تحليل بيانات متقدم وربط لوحة بيانات حية (Live Dashboard)' },
  pricingCustomFeature6: { en: 'Flexible: add or remove services on demand', ar: 'إمكانية إضافة أو حذف خدمات على حسب الطلب' },
