...
const translations: Translations = {
  ...
  aboutImgAlt: { en: 'About our company', ar: 'صورة عن شركتنا' },
  aboutBadge: { en: 'Who We Are', ar: 'من نحن' },
  aboutTitle: { en: 'Your Partners for Digital Success', ar: 'شركاء نجاحك في العالم الرقمي' },
  aboutDescription: { en: 'We are D-Arrow, an integrated digital marketing and technology agency. We believe that success is not a coincidence, but a mix of strategic planning, creativity, and data-driven insights. Our goal is to turn your vision into a tangible digital reality through innovative marketing and technical solutions that exceed expectations.', ar: 'نحن دي أرو، وكالة تسويق رقمي وتقنية متكاملة. نؤمن بأن النجاح لا يأتي بالصدفة، بل هو مزيج من التخطيط الاستراتيجي، والإبداع، والاعتماد على البيانات. هدفنا هو تحويل رؤيتك إلى واقع رقمي ملموس من خلال حلول تسويقية وبرمجية مبتكرة تتجاوز التوقعات.' },
  aboutFeature1Title: { en: 'Data-Driven Approach', ar: 'نهج مبني على البيانات' },
  aboutFeature1Desc: { en: 'Our marketing decisions rely on precise analytics to ensure the highest ROI.', ar: 'قراراتنا التسويقية تعتمد على تحليلات دقيقة لضمان أعلى عائد استثماري.' },
  aboutFeature2Title: { en: 'Diverse Expertise', ar: 'خبرات مختصة وموثوقة' },
  aboutFeature2Desc: { en: 'A passionate team with deep expertise in marketing and tech solutions across MENA.', ar: 'فريق يمتلك خبرة واسعة وشغفاً في حلول التسويق والبرمجة بالشرق الأوسط.' },
  aboutCTA: { en: 'Learn More About Us', ar: 'المزيد عن إنجازاتنا' },
  ...
  service_ppc_desc: { en: 'Maximize ROI with targeted PPC campaigns across Google, Facebook, and more.', ar: 'اقصد الحد الأقصى للعائد على الاستثمار مع حملات الدفع مقابل النقرة المستهدفة عبر جوجل وفيسبوك وغيرها.' },
  ...
  serviceFeatures_software: { en: ['ERP Software', 'CRM Software', 'HR Software', 'Custom Development'], ar: ['تخطيط موارد المؤسسات', 'إدارة علاقات العملاء', 'برنامج الموارد البشرية', 'التطوير المخصص'] },
  ...
  serviceFeatures_softwareDev: { en: ['Custom Development', 'Scalable Solutions', 'Quality Assurance', 'Maintenance Support', 'API Integration', 'Database Design', 'Security Implementation', 'Cloud Deployment'], ar: ['التطوير المخصص', 'حلول قابلة للتوسع', 'ضمان الجودة', 'دعم الصيانة', 'دمج واجهة البرمجة', 'تصميم قاعدة البيانات', 'تنفيذ الأمان', 'نشر سحابي'] },
  ...
  serviceFeatures_websiteDev: { en: ['Responsive Design', 'Fast Loading', 'SEO Friendly', 'CMS Integration', 'Responsive Design', 'SEO Integration', 'Fast Loading', 'Security Features'], ar: ['تصميم متجاوب', 'تحميل سريع', 'محسّن للبحث', 'دمج نظام إدارة المحتوى', 'تصميم متجاوب', 'دمج تحسين محركات البحث', 'تحميل سريع', 'ميزات الأمان'] },
  ...
  serviceFeatures_seoNew: { en: ['Keyword Research', 'On-Page SEO', 'Link Building', 'Analytics Tracking', 'Local SEO Setup', 'Monthly Reports', 'Competitor Analysis'], ar: ['البحث عن الكلمات المفتاحية', 'تحسين الصفحة', 'بناء الروابط', 'تتبع التحليلات', 'إعداد البحث المحلي', 'تقارير شهرية', 'تحليل المنافسين'] },
  ...
  serviceFeatures_ppcNew: { en: ['Google Ads', 'Social Media Ads', 'Bid Management', 'ROI Optimization', 'Conversion Tracking', 'ROI Reporting', 'A/B Testing'], ar: ['إعلانات جوجل', 'إعلانات وسائل التواصل الاجتماعي', 'إدارة العروض', 'تحسين العائد على الاستثمار', 'تتبع التحويل', 'تقارير العائد على الاستثمار', 'اختبار أ/ب'] },
  ...
  pricingBasicOldPrice: { en: '4,500 SAR', ar: '4,500 ريال سعودي' },
  ...
  pricingBasicFeature3: { en: 'Trending hashtag research', ar: 'بحث وتحديث الهاشتاجات الأكثر رواجاً وملاءمة للنشاط.' },
  pricingBasicFeature4: { en: 'Account profile setup & optimization', ar: 'ضبط وتحسين واجهة الحساب (البايو، الهايلايتس).' },
  pricingBasicFeature5: { en: 'Post scheduling at peak times', ar: 'جدولة النشر في أوقات ذروة التفاعل للجمهور المستهدف.' },
  pricingBasicFeature6: { en: 'Product photography visual ideas (Moodboard)', ar: 'تقديم أفكار مرئية لتصوير المنتجات (Moodboard).' },
  pricingBasicFeature7: { en: 'Monthly report with competitor analysis', ar: 'تقرير أداء شهري يتضمن تحليل المنافسين الأساسي.' },
  
  // Pricing Card - Growth Plan
  pricingGrowth: { en: 'Growth', ar: 'باقة النمو' },
  pricingGrowthPrice: { en: '7,500 SAR', ar: '7,500 ريال سعودي' },
  pricingGrowthOldPrice: { en: '9,500 SAR', ar: '9,500 ريال سعودي' },
  ...
  pricingGrowthFeature3: { en: 'Professional engagement management', ar: 'إدارة التفاعل والرد على الرسائل والتعليقات بأسلوب احترافي.' },
  pricingGrowthFeature4: { en: 'Paid ad campaigns (budget separate)', ar: 'إدارة حملات إعلانية ممولة لزيادة المتابعين والمبيعات (الميزانية الإعلانية منفصلة).' },
  pricingGrowthFeature5: { en: 'Pixel tracking setup (Facebook/Snapchat)', ar: 'ضبط إعدادات الربط التقني (Facebook Pixel, Snapchat Pixel).' },
  pricingGrowthFeature6: { en: 'On-page SEO for core products', ar: 'تحسين أرشفة المنتجات الأساسية (On-page SEO).' },
  pricingGrowthFeature7: { en: 'Influencer marketing plan (3 influencers)', ar: 'إعداد خطة تسويق عبر المؤثرين (ترشيح والتواصل مع 3 مؤثرين).' },
  pricingGrowthFeature8: { en: 'Abandoned cart SMS/Push Notifications copy', ar: 'كتابة محتوى لرسائل التذكير بالسلات المتروكة (SMS/Push Notifications).' },
  pricingGrowthFeature9: { en: 'Detailed bi-weekly performance report', ar: 'تقرير أداء نصف شهري مفصل لمتابعة النمو والمبيعات.' },
  ...
  pricingProfessionalOldPrice: { en: '11,500 SAR', ar: '11,500 ريال سعودي' },
  ...
  pricingProfessionalFeature3: { en: 'Retargeting campaigns', ar: 'إدارة حملات إعادة الاستهداف (Retargeting) لرفع نسبة التحويل.' },
  pricingProfessionalFeature4: { en: 'Full technical & UI/UX audit', ar: 'فحص فني شامل للمتجر الإلكتروني وتجربة المستخدم (UI/UX).' },
  pricingProfessionalFeature5: { en: 'Landing page design & optimization', ar: 'تصميم وتحسين صفحات الهبوط (Landing Pages) للحملات.' },
  pricingProfessionalFeature6: { en: 'A/B testing for offers & ad copy', ar: 'اختبار (A/B Testing) للعروض والنصوص الإعلانية.' },
  pricingProfessionalFeature7: { en: '2 SEO-optimized blog articles/month', ar: 'كتابة 2 مقال مدونة شهرياً متوافق مع الـ SEO لتعزيز الزيارات العضوية.' },
  pricingProfessionalFeature8: { en: 'Email marketing campaigns', ar: 'إطلاق وإدارة حملات البريد الإلكتروني (Email Marketing).' },
  pricingProfessionalFeature9: { en: 'Customer journey analysis to fix drop-offs', ar: 'تحليل رحلة العميل داخل المتجر لاكتشاف وحل مشاكل التسرب.' },
  pricingProfessionalFeature10: { en: 'Monthly consulting meeting for ROI analysis', ar: 'اجتماع استشاري شهري لتحليل العائد على الاستثمار (ROI).' },
  
  // Pricing Card - Custom Plan
  pricingCustom: { en: 'Custom Package', ar: 'الباقة المخصصة' },
  pricingCustomPrice: { en: 'Custom Pricing', ar: 'أسعار مخصصة (بناءً على النطاق)' },
  pricingCustomFeature1: { en: 'Comprehensive strategic marketing', ar: 'تسويق استراتيجي شامل ومتكامل (سوشيال ميديا، محتوى، إعلانات، SEO متقدم).' },
  pricingCustomFeature2: { en: 'Full expansion strategy for new markets', ar: 'استراتيجية كاملة للتوسع في أسواق وفئات مستهدفة جديدة.' },
  pricingCustomFeature3: { en: 'Full Google Ads management (Search, Display, Shopping)', ar: 'إدارة شاملة لحسابات Google Ads (شبكة البحث، العرض، التسوّق).' },
  pricingCustomFeature4: { en: 'Dedicated account manager & direct communication', ar: 'مدير حساب مخصص وتواصل مباشر وسريع.' },
  pricingCustomFeature5: { en: 'Advanced data analytics (Looker Studio)', ar: 'تحليل بيانات متقدم وربط لوحة بيانات حية (مثل Looker Studio).' },
  pricingCustomFeature6: { en: 'Full brand identity development', ar: 'تطوير هوية بصرية ولفظية كاملة للمشروع التجاري.' },
  pricingCustomFeature7: { en: 'Continuous sales funnels optimization', ar: 'استشارات مستمرة لتطوير مسارات المبيعات (Sales Funnels).' },
  pricingCustomFeature8: { en: 'Flexible add/remove services', ar: 'إمكانية إضافة أو حذف أي خدمات بناءً على احتياج الأعمال.' },
  ...
  pricingStarterFeature3: { en: 'Basic UI/UX Design', ar: 'تصميم واجهة وتجربة المستخدم الأساسي' },
  pricingStarterFeature4: { en: 'Contact Form Integration', ar: 'تكامل نموذج الاتصال' },
  pricingStarterFeature5: { en: 'Basic SEO Setup', ar: 'إعداد تحسين محركات البحث الأساسي' },
  ...
  pricingBusinessFeature2: { en: 'Custom UI/UX Design', ar: 'تصميم واجهة وتجربة المستخدم المخصص' },
  ...
  pricingBusinessFeature5: { en: 'On-Page SEO Optimization', ar: 'تحسين محركات البحث داخل الصفحة' },
  pricingBusinessFeature6: { en: 'WhatsApp / Live Chat Integration', ar: 'تكامل واتس آب / الدردشة المباشرة' },
  ...
  pricingEnterpriseFeature1: { en: 'Custom Web Application / ERP / CRM', ar: 'تطبيق ويب مخصص / تخطيط موارد المؤسسات / إدارة علاقات العملاء' },
  pricingEnterpriseFeature2: { en: 'API Integration', ar: 'دمج واجهة البرمجة' },
  pricingEnterpriseFeature3: { en: 'Advanced Database Architecture', ar: 'بنية قاعدة البيانات المتقدمة' },
  pricingEnterpriseFeature4: { en: 'Role-based Admin System', ar: 'نظام إداري قائم على الأدوار' },
  pricingEnterpriseFeature5: { en: 'Cloud Deployment (AWS / VPS)', ar: 'نشر سحابي (خدمات أمازون السحابية / خوادم افتراضية)' },
  ...
  saasTitle: { en: 'Beedco', ar: 'هوية علامة تجارية' },
  saasDesc: { en: 'Developed a comprehensive brand identity for a new SaaS startup, including logo, color palette, and a full brand style guide to ensure consistency.', ar: 'طورنا هوية علامة تجارية شاملة لشركة برمجيات ناشئة جديدة، تشمل الشعار ولوحة الألوان وكتيب نمط العلامة التجارية الكامل لضمان الاتساق.' },
  ...
  dm_google_ads: { en: 'Google Ads Management', ar: 'إدارة إعلانات جوجل' },
  ...
  dm_seo_title: { en: 'SEO & SRO', ar: 'تحسين محركات البحث وتحسين السمعة' },
  ...
  features_appsDesign: { en: ['UI/UX design', 'iOS development', 'Android development', 'Testing & QA', 'Deployment support'], ar: ['تصميم واجهة المستخدم', 'تطوير أبل', 'تطوير أندرويد', 'الاختبار وضمان الجودة', 'دعم النشر'] },
  ...
  features_softwareDesign: { en: ['Custom development', 'Architecture design', 'Database design', 'API integration', 'Maintenance & support'], ar: ['التطوير المخصص', 'تصميم البنية', 'تصميم قاعدة البيانات', 'دمج واجهة البرمجة', 'الصيانة والدعم'] },
  features_cloudServices: { en: ['Infrastructure setup', 'Deployment services', 'Scaling solutions', 'Security management', '24/7 monitoring'], ar: ['إعداد البنية التحتية', 'خدمات النشر', 'حلول التوسع', 'إدارة الأمان', 'المراقبة على مدار الساعة'] },
  ...
  portfolio: { en: 'Portfolio', ar: 'بورتفوليو' },
