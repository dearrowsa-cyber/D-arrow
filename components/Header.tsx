...
hover:shadow-md hover:scale-105 active:scale-95 whitespace-nowrap">
        ...
        {isMenuOpen && (
          <nav className="lg:hidden mt-4 space-y-2 pb-4 max-h-96 overflow-y-auto">
            <Link href="/" onClick={() => handleNavClick('/')} className="flex items-center gap-2 px-4 py-3 min-h-[44px] font-medium !text-white hover:text-brand-pink hover:bg-[rgba(255,77,109,0.1)] transition text-2xl rounded-lg">{t('home')}</Link>
            <div className="relative">
              ...
              <div 
                ...
                <div className="flex flex-col gap-2 p-2">
                  <Link href="/services?category=digital-marketing" onClick={() => { setServicesOpen(false); handleNavClick('/services'); }} className={`dropdown-item-hover flex ${lang === 'ar' ? 'flex-row-reverse' : ''} gap-4 items-center p-3 sm:p-4 min-h-[54px] rounded-lg hover:bg-[rgba(255,77,109,0.15)] transition w-full mb-1`}>
                    ...
                    <div className={`${lang === 'ar' ? 'text-right' : 'text-left'} flex-1`}>
                      <h4 className="text-[15px] font-bold text-white">{t('digitalMarketingHeader')}</h4>
                    </div>
                  </Link>

                  <Link href="/services?category=innovation-development" onClick={() => { setServicesOpen(false); handleNavClick('/services'); }} className={`dropdown-item-hover flex ${lang === 'ar' ? 'flex-row-reverse' : ''} gap-4 items-center p-3 sm:p-4 min-h-[54px] rounded-lg hover:bg-[rgba(255,77,109,0.15)] transition w-full mb-1`}>
                    ...
                    <div className={`${lang === 'ar' ? 'text-right' : 'text-left'} flex-1`}>
                      <h4 className="text-[15px] font-bold text-white">{t('innovationHeader')}</h4>
                    </div>
                  </Link>

                  <Link href="/services?category=real-estate" onClick={() => { setServicesOpen(false); handleNavClick('/services'); }} className={`dropdown-item-hover flex ${lang === 'ar' ? 'flex-row-reverse' : ''} gap-4 items-center p-3 sm:p-4 min-h-[54px] rounded-lg hover:bg-[rgba(255,77,109,0.15)] transition w-full`}>
                    ...
                    <div className={`${lang === 'ar' ? 'text-right' : 'text-left'} flex-1`}>
                      <h4 className="text-[15px] font-bold text-white">{t('realEstateHeader')}</h4>
                    </div>
                  </Link>
                </div>
              </div>
            ...
            <Link href="/pricing" onClick={() => handleNavClick('/pricing')} className="flex items-center gap-2 px-4 py-3 min-h-[44px] font-medium !text-white hover:text-brand-pink hover:bg-[rgba(255,77,109,0.1)] transition text-2xl rounded-lg">{t('packages')}</Link>
            <Link href="/why-us" onClick={() => handleNavClick('/why-us')} className="flex items-center gap-2 px-4 py-3 min-h-[44px] font-medium !text-white hover:text-brand-pink hover:bg-[rgba(255,77,109,0.1)] transition text-2xl rounded-lg">{t('ourCommitment')}</Link>
            
            <Link href="/provisions" onClick={() => handleNavClick('/provisions')} className="flex items-center gap-2 px-4 py-3 min-h-[44px] font-medium !text-white hover:text-brand-pink hover:bg-[rgba(255,77,109,0.1)] transition text-2xl rounded-lg">{t('portfolio')}</Link>
            <Link href="/store" onClick={() => handleNavClick('/store')} className="flex items-center gap-2 px-4 py-3 min-h-[44px] font-medium !text-white hover:text-brand-pink hover:bg-[rgba(255,77,109,0.1)] transition text-2xl rounded-lg">{lang === 'ar' ? 'المتجر' : 'Store'}</Link>
            <Link href="/blog" onClick={() => handleNavClick('/blog')} className="flex items-center gap-2 px-4 py-3 min-h-[44px] font-medium !text-white hover:text-brand-pink hover:bg-[rgba(255,77,109,0.1)] transition text-2xl rounded-lg">{t('blog')}</Link>
            
            <Link href="/contact" onClick={() => handleNavClick('/contact')} className="flex items-center gap-2 px-4 py-3 min-h-[44px] font-medium !text-white hover:text-brand-pink hover:bg-[rgba(255,77,109,0.1)] transition text-2xl rounded-lg">{t('contact')}</Link>
          </nav>
        )}
      </div>
    </header>
