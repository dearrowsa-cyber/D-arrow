  ...
  return (
    <section className="relative py-16 lg:py-24 overflow-hidden border-b border-gray-800/50">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
        <div
          className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-20 ${lang === "ar" ? "lg:flex-row-reverse" : ""}`}
        >
          {/* Image Side */}
          <motion.div
          ...
          >
            ...
            {/* Decorative element */}
            <div
              className={`absolute -bottom-6 ${lang === "ar" ? "-right-6" : "-left-6"} w-24 h-24 bg-brand-orange/20 rounded-full blur-2xl -z-10`}
            ></div>
            <div
              className={`absolute -top-6 ${lang === "ar" ? "-left-6" : "-right-6"} w-32 h-32 bg-brand-pink/20 rounded-full blur-2xl -z-10`}
            ></div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full mb-10">
              <div className="flex flex-col gap-2">
                ...
                <p
                  className={`text-sm text-gray-500 dark:text-gray-400 ${lang === "ar" ? "pr-13 text-right" : "pl-13 text-left"}`}
                >
                  {t("aboutFeature1Desc")}
                </p>
              </div>
