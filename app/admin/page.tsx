    ...
    <div className="admin-content">
      ...
      <div className="admin-grid-3" style={{ marginBottom: 32 }}>
        ...
        >
          <div
            ...
            style={{ color: "#E6E6EA", fontSize: 32 }}
          >
        ...
        <div
          ...
          style={{ padding: "16px 24px", background: "rgba(255,154,60,0.05)" }}
        >
          <h4 style={{ color: "#FF9A3C", fontSize: 14, margin: "0 0 8px" }}>
          ...
          >
            ...
            {(!analytics?.topPages || analytics.topPages.length === 0) && (
              <li style={{ color: "#6B7280", fontSize: 13 }}>لا توجد بيانات</li>
            )}
          </ul>
        </div>
      </div>
      ...
      <div className="admin-grid-3" style={{ marginBottom: 32 }}>
        <Link href="/admin/posts/new" style={{ textDecoration: "none" }}>
          ...
          >
            ...
            <h4 style={{ color: "#E6E6EA", fontSize: 16, margin: "0 0 4px" }}>
              إنشاء مقال جديد
            </h4>
            <p style={{ color: "#6B7280", fontSize: 13, margin: 0 }}>
              اكتب مقال جديد للمدونة
            </p>
          </div>
        </Link>
      ...
      <div className="admin-grid-4" style={{ marginBottom: 32 }}>
        ...
        >
          ...
          <div className="admin-stat-value" style={{ color: "#22C55E" }}>
            {analytics.store?.totalRevenue?.toFixed(0) || 0}{" "}
            <span style={{ fontSize: 14, fontWeight: 500 }}>ر.س</span>
          </div>
        ...
        <Link href="/admin/store/orders" style={{ textDecoration: "none" }}>
          <div
            className="admin-stat-card"
            style={{ cursor: "pointer", background: "rgba(59,130,246,0.03)" }}
          >
            <div className="admin-stat-icon blue">
              <ShoppingBag size={24} />
            </div>
            <div className="admin-stat-value">
              {analytics.store?.totalOrders || 0}
            </div>
        ...
        <Link href="/admin/store/products" style={{ textDecoration: "none" }}>
          <div
            className="admin-stat-card"
            style={{ cursor: "pointer", background: "rgba(255,77,109,0.03)" }}
          >
            <div className="admin-stat-icon pink">
              <Package size={24} />
            </div>
            <div className="admin-stat-value">
              {analytics.store?.totalProducts || 0}
            </div>
        ...
        <Link
          href={
            analytics.store?.pendingReviews > 0
              ? "/admin/store/reviews"
              : "/admin/store/coupons"
          }
          style={{ textDecoration: "none" }}
        >
          ...
          >
            <div
              className={`admin-stat-icon ${analytics.store?.pendingReviews > 0 ? "warning" : "orange"}`}
              style={{
                background:
                  analytics.store?.pendingReviews > 0
                    ? "rgba(234,179,8,0.15)"
                    : undefined,
                color:
                  analytics.store?.pendingReviews > 0 ? "#EAB308" : undefined,
              }}
            >
              <Star size={24} />
            </div>
            <div className="admin-stat-value">
              {analytics.store?.pendingReviews > 0
                ? analytics.store.pendingReviews
                : analytics.store?.totalCoupons || 0}
            </div>
            <div className="admin-stat-label">
              {analytics.store?.pendingReviews > 0
                ? "تقييمات بانتظار الموافقة ⚠️"
                : "الكوبونات النشطة"}
            </div>
          </div>
        </Link>
      ...
      >
        ...
        >
          ...
          >
            تحكم كامل في نصوص وصور الواجهة الرئيسية، خدماتنا، من نحن، الهيرو،
            وأي جزء من أجزاء الموقع بشكل مباشر وبدون كود.
          </p>
          <Link
            href="/admin/pages"
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(180deg, rgba(255,77,109,0.05) 0%, transparent 100%)",
          }}
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div
            ...
            >
              المدونة ومولد الـ AI (الذكاء الاصطناعي)
            </h3>
          </div>
          <p
            style={{
          ...
          >
            الاستعانة بالذكاء الاصطناعي (AI) لكتابة وتحسين عناوين ووصف SEO
            للمقالات، مع إدارة شاملة لمدونة الموقع لدعم محركات البحث.
          </p>
          <Link
            href="/admin/posts"
            className="admin-btn admin-btn-primary"
            style={{
              ...
              alignSelf: "flex-start",
              padding: "12px 28px",
              background: "linear-gradient(135deg, #FF9A3C 0%, #FF4D6D 100%)",
              border: "none",
            }}
          >
