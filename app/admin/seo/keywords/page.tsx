...
export default function KeywordRankTracker() {
  ...
  if (loading)
    return <div className="admin-content">جاري تحميل المتتبع...</div>;
    ...
    <div className="admin-content">
      ...
      {deleteId && (
        <div className="admin-overlay" style={{ zIndex: 9999 }}>
          <div className="admin-dialog">
            <h3 style={{ color: "#E6E6EA", margin: "0 0 12px" }}>
              هل أنت متأكد؟
            </h3>
      ...
      >
        <div>
          <h2 style={{ margin: "0 0 8px" }}>
            متتبع الكلمات المفتاحية (Rank Tracker)
          </h2>
          <p style={{ color: "#9CA3AF", margin: 0 }}>
            تتبع ترتيب موقعك في جوجل للكلمات المستهدفة
          </p>
        </div>
      ...
      >
        ...
        <button
          className="admin-btn admin-btn-secondary"
          style={{
            color: filterStarred ? "#F59E0B" : "#9CA3AF",
            borderColor: filterStarred ? "#F59E0B" : "",
          }}
              ...
              <tr key={kw.id}>
                <td>
                  ...
                  >
                    <Star
                      size={18}
                      color={kw.starred ? "#F59E0B" : "#6B7280"}
                      fill={kw.starred ? "#F59E0B" : "none"}
                    />
                  </button>
                </td>
