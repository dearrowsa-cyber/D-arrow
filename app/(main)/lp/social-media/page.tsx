    ...
    <div className="min-h-screen bg-[#0a0e27] text-white overflow-hidden">
      ...
      <section className="py-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div
            className={`grid grid-cols-1 lg:grid-cols-3 gap-12 ${isRTL ? "dir-rtl" : ""}`}
          >
            {[
              {
        ...
        <div className="max-w-5xl mx-auto rounded-[40px] bg-gradient-to-br from-brand-pink to-brand-orange p-1 px-1">
          <div className="bg-[#0a0e27] rounded-[39px] py-20 px-8 md:px-16 text-center">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
              {isRTL
                ? "انضم إلى قائمة عملائنا المميزين وابدأ رحلة النمو اليوم مع أقوى استراتيجيات التسويق."
                : "Join our elite client list and start your growth journey today with the most powerful marketing strategies."}
            </p>
            <Link
              href="/contact"
      ...
      <footer className="py-12 text-center text-gray-600 text-sm border-t border-white/5">
        &copy; 2026 D-Arrow Digital Agency. All results are verified client
        outcomes.
      </footer>
    </div>
  );
