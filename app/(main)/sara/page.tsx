...
export default function SaraPage() {
  ...
  return (
    ...
    >
      ...
      <main className="flex-grow">
        ...
        <section className="relative overflow-hidden py-20 md:py-28 px-6">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10 space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-300 text-xs md:text-sm font-medium">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <a
                href="#products"
                className="px-8 py-3.5 rounded-2xl bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 text-white font-bold shadow-xl shadow-rose-500/30 transition transform hover:-translate-y-1 text-sm md:text-base"
              >
                استعراض التشكيلة
              </a>
              <a
                href="mailto:info@sara.d-arrow.com"
                className="px-8 py-3.5 rounded-2xl bg-[#14172e] hover:bg-[#1a1e3a] border border-white/10 font-bold transition flex items-center gap-2 text-sm md:text-base"
              >
            ...
            {products.map((p) => (
              ...
              >
                ...
                <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                  <div>
                    <h4 className="font-bold text-base md:text-lg text-white group-hover:text-rose-300 transition">
                      {p.name}
                    </h4>
        ...
        <section className="py-16 md:py-20 px-6 bg-gradient-to-b from-transparent via-rose-950/20 to-transparent">
      ...
      {/* Footer */}
      <footer className="w-full py-10 px-6 border-t border-white/10 text-slate-500 flex flex-col items-center justify-center min-h-[120px] bg-[#070913]">
        <div className="flex flex-col items-center justify-center gap-2 text-center text-xs md:text-sm">
          <p className="font-medium">© 2026 سارة (Sara) — جميع الحقوق محفوظة</p>
          <p className="opacity-60">مدعوم ومستضاف لدى D-Arrow</p>
        </div>
      </footer>
    </div>
  );
