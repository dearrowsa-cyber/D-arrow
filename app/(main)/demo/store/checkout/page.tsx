...
const DEMO_CART = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1547887537-6158d64c35b3?auto=format&fit=crop&w=200&q=80",
    price: 199,
    oldPrice: 260,
    quantity: 2,
  },
...
const PAYMENT_METHODS: {
...
}[] = [
  {
    ...
    nameEn: "Mada",
    icon: "🇸🇦",
    desc: "الدفع الفوري عبر البطاقات البنكية السعودية",
  ...
  },
  {
    ...
    icon: "💳",
    desc: "بطاقات ائتمانية دولية ومحلية مع تشفير 256-bit",
    color: "#3B82F6",
    hasCardForm: true,
  },
  {
    ...
    nameEn: "Apple Pay",
    icon: "",
    desc: "دفع بنقرة واحدة آمنة من جهاز آيفون أو آيباد",
    badge: "الأسرع",
    color: "#FFFFFF",
    hasCardForm: false,
  },
  {
    id: "tabby",
    name: "تابي - قسّط على 4",
    nameEn: "Tabby",
    icon: "💚",
    desc: "قسّم المبلغ على 4 دفعات بدون فوائد أو رسوم إضافية",
    badge: "بدون فوائد",
    color: "#34D399",
    hasCardForm: false,
  },
  {
    id: "tamara",
    name: "تمارا - ادفع لاحقاً",
    nameEn: "Tamara",
    icon: "🧡",
    desc: "ادفع بعد 30 يوم أو قسّط على 3 دفعات مريحة",
    color: "#FB923C",
    hasCardForm: false,
  },
  {
    ...
    icon: "🏦",
    desc: "تحويل مباشر إلى الراجحي، الأهلي، أو الإنماء",
    color: "#A855F7",
    hasCardForm: false,
  },
];
...
export default function CheckoutPage() {
  ...
  const validateShipping = (): boolean => {
    ...
    if (
      !shipping.phone.trim() ||
      !/^05\d{8}$/.test(shipping.phone.replace(/\s/g, ""))
    )
      errs.phone = "رقم جوال سعودي صحيح (05XXXXXXXX)";
  ...
  const handlePaymentSubmit = () => {
    ...
    setTimeout(() => {
      setOrderId(
        `SA-${Date.now().toString(36).toUpperCase()}-${Math.floor(1000 + Math.random() * 9000)}`,
      );
      setStep("confirmed");
    }, 3600);
  };
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: "linear-gradient(90deg, #3F6212, #047857)",
          color: "white",
          padding: "8px 16px",
          display: "flex",
      ...
      >
        ...
        <span className="hidden sm:inline">
          🔒 اتصال مشفر 256-bit SSL — جميع بياناتك محمية ومعتمدة (PCI-DSS
          Compliant) 🇸🇦
        </span>
      ...
      <div
        style={{ maxWidth: 1100, margin: "20px auto 60px" }}
        className="px-3 sm:px-6"
      >
        <div
          className="flex flex-col lg:grid gap-6 lg:gap-8 items-start"
          style={{
            gridTemplateColumns:
              step === "processing" || step === "confirmed"
                ? "1fr"
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      عنوان الشحن بالمملكة 🇸🇦
                    </h2>
                    <p style={{ fontSize: 12, color: "#9CA3AF", margin: 0 }}>
                      أدخل بيانات الشحن لتوصيل طلبك
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        border: `1px solid ${shippingErrors.fullName ? "#EF4444" : "rgba(255,255,255,0.08)"}`,
                        borderRadius: 12,
                        color: "white",
                        outline: "none",
                        fontSize: 14,
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          paddingRight: 60,
                          background: "rgba(0,0,0,0.3)",
                          border: `1px solid ${shippingErrors.phone ? "#EF4444" : "rgba(255,255,255,0.08)"}`,
                          borderRadius: 12,
                          color: "white",
                          outline: "none",
                          fontSize: 14,
                  ...
                  <div>
                    ...
                    >
                      <Mail size={13} /> البريد الإلكتروني (اختياري)
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{
                        ...
                        padding: "12px 14px",
                        background: "rgba(0,0,0,0.3)",
                        border: `1px solid ${shippingErrors.city ? "#EF4444" : "rgba(255,255,255,0.08)"}`,
                        borderRadius: 12,
                        color: "white",
                        outline: "none",
                        fontSize: 14,
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setShipping((p) => ({ ...p, district: e.target.value }))
                      }
                      ...
                      style={{
                        ...
                        padding: "12px 14px",
                        background: "rgba(0,0,0,0.3)",
                        border: `1px solid ${shippingErrors.district ? "#EF4444" : "rgba(255,255,255,0.08)"}`,
                        borderRadius: 12,
                        color: "white",
                        outline: "none",
                        fontSize: 14,
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        padding: "12px 14px",
                        background: "rgba(0,0,0,0.3)",
                        border: `1px solid ${shippingErrors.street ? "#EF4444" : "rgba(255,255,255,0.08)"}`,
                        borderRadius: 12,
                        color: "white",
                        outline: "none",
                        fontSize: 14,
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setShipping((p) => ({ ...p, notes: e.target.value }))
                      }
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      {shippingCost === 0
                        ? "🎉 شحن مجاني! طلبك أعلى من 300 ر.س"
                        : `رسوم الشحن: ${shippingCost} ر.س (مجاني للطلبات فوق 300 ر.س)`}
                    </p>
                    <p
                      style={{
                        margin: "4px 0 0",
                    ...
                    >
                      التوصيل المتوقع: 1-3 أيام عمل داخل{" "}
                      {shipping.city || "المملكة"}
                    </p>
                  </div>
                </div>
              ...
              <div style={{ animation: "fadeIn 0.4s ease" }}>
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: 12, color: "#9CA3AF", margin: 0 }}>
                        جميع الطرق مؤمنة ومشفرة بتقنية SSL 256-bit
                      </p>
                    </div>
                  </div>
                        ...
                        >
                          <div
                            style={{
                              ...
                              justifyContent: "center",
                              fontSize: 20,
                              border: `1px solid ${isSelected ? `${pm.color}40` : "transparent"}`,
                            }}
                          >
                            {pm.icon}
                          </div>
                          ...
                          <div
                            style={{
                              ...
                              height: 20,
                              borderRadius: "50%",
                              border: `2px solid ${isSelected ? pm.color : "#374151"}`,
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                              flexShrink: 0,
                ...
                {selectedPayment.hasCardForm && (
                  <div
                    style={{
                      background: "rgba(20,22,46,0.7)",
                      border: `1px solid ${selectedPayment.color}30`,
                      borderRadius: 24,
                      padding: 32,
                      marginBottom: 24,
                  ...
                  >
                    ...
                    >
                      <CreditCard
                        size={20}
                        style={{ color: selectedPayment.color }}
                      />
                      <h3
                        style={{
                          fontSize: 17,
                      ...
                      >
                        بيانات بطاقة {selectedPayment.name}
                      </h3>
                    </div>
                    ...
                    >
                        ...
                        <div style={{ position: "relative" }}>
                          <input
                            ...
                            style={{
                              ...
                              border: `1px solid ${selectedPayment.color}25`,
                              borderRadius: 12,
                              color: "white",
                              outline: "none",
                              fontSize: 17,
                      ...
                      >
                        <input
                          ...
                          style={{ accentColor: selectedPayment.color }}
                        />
                        <span style={{ fontSize: 13, color: "#9CA3AF" }}>
                          حفظ بيانات البطاقة للمشتريات القادمة (مشفرة)
                        </span>
                      </label>
                    </div>
                  </div>
                ...
                {paymentMethod === "applepay" && (
                  ...
                  >
                    ...
                    >
                      سيتم فتح نافذة Apple Pay على جهازك — أكّد بـ Face ID أو
                      Touch ID
                    </p>
                    <div
                      style={{
                ...
                {paymentMethod === "tabby" && (
                  ...
                  >
                          ...
                          style={{
                            background:
                              i === 1
                                ...
                                : "rgba(0,0,0,0.2)",
                            border: `1px solid ${i === 1 ? "#34D399" : "rgba(255,255,255,0.06)"}`,
                            borderRadius: 14,
                            padding: "14px 10px",
                            textAlign: "center",
                          }}
                    ...
                    >
                      <CheckCircle2 size={15} /> بدون فوائد — بدون رسوم إضافية —
                      موافقة فورية
                    </div>
                  </div>
                )}
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          تمارا — ادفع لاحقاً أو قسّط
                        </h3>
                        <p
                          style={{ fontSize: 12, color: "#9CA3AF", margin: 0 }}
                        >
                          Tamara | Pay later, split in 3
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        <Clock
                          size={24}
                          style={{ color: "#FB923C", marginBottom: 8 }}
                        />
                        <h4
                          style={{
                            fontSize: 15,
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p
                          style={{ fontSize: 12, color: "#9CA3AF", margin: 0 }}
                        >
                          حوّل المبلغ مباشرة وأرفق إيصال التحويل
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      {[
                        {
                          bank: "مصرف الراجحي",
                          iban: "SA80 0000 0000 0000 0000 0000",
                          color: "#10B981",
                        },
                        {
                          bank: "البنك الأهلي السعودي",
                          iban: "SA29 1000 0000 0000 0000 0000",
                          color: "#3B82F6",
                        },
                        {
                          bank: "مصرف الإنماء",
                          iban: "SA44 0500 0000 0000 0000 0000",
                          color: "#F59E0B",
                        },
                      ].map((b, i) => (
                        <div
                    ...
                    >
                      <AlertCircle size={15} />
                      <span>
                        يرجى تحويل المبلغ خلال 24 ساعة وإرفاق إيصال التحويل عبر
            ...
            {step === "review" && (
              <div style={{ animation: "fadeIn 0.4s ease" }}>
                ...
                >
                  ...
                  >
                    <FileText size={20} style={{ color: "#FF4D6D" }} /> مراجعة
                    الطلب النهائية
                  </h2>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Truck size={16} style={{ color: "#10B981" }} /> بيانات
                        الشحن
                      </h3>
                      <button
                        onClick={() => setStep("shipping")}
                    ...
                    >
                      ...
                      <div>
                        <span style={{ color: "#6B7280" }}>الجوال:</span>{" "}
                        {shipping.phone}
                      </div>
                      <div>
                      ...
                      <div>
                        <span style={{ color: "#6B7280" }}>الحي:</span>{" "}
                        {shipping.district}
                      </div>
                      <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  >
                    ...
                    >
                      <Package size={16} style={{ color: "#FF9A3C" }} />{" "}
                      المنتجات ({totalItems} منتج)
                    </h3>
                    {cart.map((item) => (
                      <div
                        key={item.id}
                ...
                >
                  ...
                  >
                    <input
                      ...
                      style={{ accentColor: "#10B981", marginTop: 3 }}
                    />
                    <span
                      style={{
                        fontSize: 13,
                    ...
                    >
                      ...
                      وأن المعلومات المدخلة صحيحة. أعلم أن هذا طلب تجريبي (Demo)
                      لعرض بوابة الدفع.
                    </span>
                  </label>
                </div>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: agreedToTerms
                        ? "linear-gradient(135deg,#10B981,#FFE600)"
                        : "#374151",
                      color: "white",
                      border: "none",
                      fontWeight: 800,
            ...
            {step === "processing" && (
              ...
              >
                ...
                >
                  ...
                  >
                    يرجى عدم إغلاق الصفحة — نتواصل مع البنك
                  </p>
                  ...
                  >
                    {[
                      {
                        label: "التحقق من بيانات البطاقة...",
                        done: processingProgress >= 15,
                      },
                      {
                        label: "الاتصال ببوابة الدفع الآمنة...",
                        done: processingProgress >= 35,
                      },
                      {
                        label: "التحقق من الرصيد المتاح...",
                        done: processingProgress >= 55,
                      },
                      {
                        label: "تأكيد العملية مع البنك...",
                        done: processingProgress >= 75,
                      },
                      {
                        label: "إصدار الفاتورة الإلكترونية...",
                        done: processingProgress >= 90,
                      },
                    ].map((s, i) => (
                      <div
                        key={i}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <FileText size={16} style={{ color: "#FF9A3C" }} /> فاتورة
                      إلكترونية (إيصال الدفع)
                    </h4>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          style={{
                            color: shippingCost === 0 ? "#10B981" : "#D1D5DB",
                          }}
                        >
                    ...
                    >
                      ...
                      />
                      <span>
                        تم الدفع عبر: {selectedPayment.name} (
                        {selectedPayment.nameEn})
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <span>
                        التوصيل إلى: {shipping.fullName}، {shipping.district}،{" "}
                        {shipping.city}
                      </span>
                    </div>
                  </div>
              ...
              >
                ...
                {couponMsg && (
                  <p
                    style={{
                      fontSize: 11,
                      color: discountPct > 0 ? "#22C55E" : "#EF4444",
                      margin: "0 0 10px",
                    }}
                  >
                    {couponMsg}
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{
                        color: shippingCost === 0 ? "#10B981" : "#9CA3AF",
                      }}
                    >
                      {shippingCost === 0 ? "مجاني ✨" : `${shippingCost} ر.س`}
                    </span>
                ...
                >
                  {[
                    {
                      icon: <Lock size={13} style={{ color: "#10B981" }} />,
                      text: "دفع مشفر وآمن 256-bit SSL",
                    },
                    {
                      icon: (
                        <ShieldCheck size={13} style={{ color: "#3B82F6" }} />
                      ),
                      text: "PCI-DSS Compliant معتمد",
                    },
                    {
                      icon: <Truck size={13} style={{ color: "#F59E0B" }} />,
                      text: "شحن سريع 1-3 أيام عمل 🇸🇦",
                    },
                  ].map((b, i) => (
                    <div
                      key={i}
