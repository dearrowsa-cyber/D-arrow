      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-6">
            <div>
              <span className="text-xs text-slate-400 font-bold block">رقم الشحنة الوطنية:</span>
            ...
            <div className="flex items-center gap-3">
              <div className="text-left sm:text-right">
                <span className="text-xs text-slate-400 block font-bold">موعد الوصول المتوقع:</span>
                <span className="text-base sm:text-lg font-black font-mono" style={{ color: settings.accentColor }}>
          ...
          <div className="relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden bg-[#0A0D24] border border-white/15 p-4 flex flex-col justify-between shadow-inner">
            ...
            <div className="absolute bottom-6 right-8 z-10 flex items-center gap-2 bg-[#12163A]/90 p-2.5 rounded-2xl border border-white/20 backdrop-blur-md shadow-xl">
              ...
              <div className="text-right">
                <span className="text-[10px] text-slate-400 block font-bold">نقطة الانطلاق</span>
                <span className="text-xs font-bold text-white">مستودع الرياض</span>
              </div>
            </div>
            ...
            <div className="absolute top-6 left-8 z-10 flex items-center gap-2 bg-[#12163A]/90 p-2.5 rounded-2xl border border-white/20 backdrop-blur-md shadow-xl">
              ...
              <div className="text-right">
                <span className="text-[10px] text-slate-400 block font-bold">وجهة التسليم</span>
                <span className="text-xs font-bold text-white">منزل العميل</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 sm:p-5 rounded-2xl bg-black/30 border border-white/10 items-center">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <span className="text-[10px] text-slate-400 block font-bold">مندوب التوصيل المعتمد:</span>
                <h4 className="font-extrabold text-sm text-white flex items-center gap-1.5">
                  <span>تركي العتيبي</span>
                  <span className="text-amber-400 text-xs">★ 4.9</span>
                </h4>
                <p className="text-[11px] text-slate-300 mt-0.5">سيارة توصيل مبردة &bull; لوحة أ د ح 8921</p>
              </div>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-white/10">
            <h4 className="font-black text-base text-white">سجل وتفاصيل مسار الشحنة:</h4>
            ...
            <div className="space-y-6 relative before:absolute before:right-5 before:top-3 before:bottom-3 before:w-0.5 before:bg-[#1C1707]/10 pr-2">
              {TRACKING_STEPS.map((step, idx) => {
                ...
                return (
                  <div key={idx} className="relative flex items-start gap-4 pr-3 group">
                    <div 
                    ...
                    <div className="flex-1 bg-black/20 p-4 rounded-2xl border border-white/5 space-y-1">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <span className="text-[11px] font-mono text-slate-400 font-bold">{step.time}</span>
                      </div>
                      <p className="text-xs text-slate-300 leading-relaxed font-light">{step.subtitle}</p>
