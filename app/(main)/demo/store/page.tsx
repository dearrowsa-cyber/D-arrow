  ...
  return (
    <div dir="rtl" style={{ background: '#0B0D1F', color: '#E6E6EA', minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '14px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16 }}>
          <Link href="/demo/store" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            ...
            <div style={{ borderRight: '1px solid rgba(255,255,255,0.1)', paddingRight: 10 }}>
              ...
              <span style={{ fontSize: 10, color: '#9CA3AF' }}>Saudi E-Commerce Demo</span>
            </div>
          </Link>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 24 }}>
          {filteredProducts.map((product) => {
            ...
            return (
              ...
              >
                <Link href={`/demo/store/${product.id}`} style={{ height: 230, position: 'relative', overflow: 'hidden', background: '#14162E', display: 'block' }}>
                ...
                <div style={{ padding: '18px 20px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <div>
                    ...
                    <Link href={`/demo/store/${product.id}`} style={{ textDecoration: 'none' }}>
                      <h3 style={{ fontSize: 16, fontWeight: 700, color: 'white', margin: '0 0 8px', lineHeight: 1.4 }}>{product.name}</h3>
                    </Link>
      ...
      <footer style={{ marginTop: 80, borderTop: '1px solid rgba(255,255,255,0.06)', padding: '40px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center', fontSize: 12, color: '#6B7280' }}>
