    ...
    <div className="min-h-screen text-white pb-20">
      ...
      <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div
            className={`flex flex-col lg:flex-row items-center gap-12 ${isAr ? "lg:flex-row-reverse" : ""}`}
          >
            {/* Text Content */}
            <div
              className={`flex-1 text-center ${isAr ? "lg:text-right" : "lg:text-left"}`}
            >
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FF4D6D]/10 border border-[#FF4D6D]/20 backdrop-blur-sm">
                  ...
                  <span className="text-xs sm:text-sm font-bold tracking-wide text-[#FF4D6D]">
                    {isAr
                      ? "منصة وشبكة مؤثري دي آرو"
                      : "D-Arrow Influencer Network"}
                  </span>
                </div>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                {isAr ? (
                  <>
                    أطلق العنان لإمكانياتك مع{" "}
                    <span className="bg-gradient-to-r from-[#FF4D6D] to-[#FF9A3C] bg-clip-text text-transparent">
                      D-arrow
                    </span>
                  </>
                ) : (
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: (
                  <Layout className="w-8 h-8" stroke="url(#brandGradient)" />
                ),
                title: isAr
                  ? "صفحة احترافية خاصة"
                  : "Personal Professional Page",
                desc: isAr
                  ? "نصمم لك مدونة أو صفحة احترافية تعكس هويتك وتبرز محتواك بأفضل شكل"
                  : "We design a professional blog or page that reflects your identity and showcases your content.",
              },
              {
                icon: (
                  <Globe className="w-8 h-8" stroke="url(#brandGradient)" />
                ),
                title: isAr ? "وصول عالمي" : "Global Reach",
                desc: isAr
                  ? "نساعدك في الوصول لجمهور أوسع وبناء قاعدة جماهيرية قوية"
                  : "We help you reach a wider audience and build a strong fan base.",
              },
              {
                icon: (
                  <Sparkles className="w-8 h-8" stroke="url(#brandGradient)" />
                ),
                title: isAr
                  ? "دعم فني وتسويقي"
                  : "Technical & Marketing Support",
                desc: isAr
                  ? "فريق كامل من الخبراء جاهز لدعمك تقنياً وتسويقياً على مدار الساعة"
                  : "A full team of experts ready to support you technically and in marketing 24/7.",
              },
              {
                icon: (
                  <TrendingUp
                ...
                desc: isAr
                  ? "فرص للتعاون مع علامات تجارية رائدة وزيادة مصادر دخلك"
                  : "Opportunities to collaborate with leading brands and increase your income sources.",
              },
              {
                icon: (
                  <ShieldCheck
                ...
                desc: isAr
                  ? "العمل تحت مظلة كيان احترافي يزيد من ثقة الجمهور والعلامات التجارية بك"
                  : "Working under a professional entity increases the trust of the audience and brands in you.",
              },
              {
                icon: (
                  <Users className="w-8 h-8" stroke="url(#brandGradient)" />
                ),
                title: isAr ? "مجتمع مؤثرين" : "Influencers Community",
                desc: isAr
                  ? "انضم لشبكة واسعة من المؤثرين وشارك الخبرات والنجاحات"
                  : "Join a wide network of influencers and share experiences and successes.",
              },
            ].map((benefit, idx) => (
              <div
                key={idx}
                className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 group"
              >
