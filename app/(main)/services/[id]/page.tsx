...
const DETAILED_SERVICES: Record<string, any> = {
  dm_smm: {
    ar: {
      ...
      subheadline:
        "صناعة حضور رقمي لا يُنسى وبناء مجتمعات تتنفس علامتك التجارية",
      content: [
      ...
      footer:
        "دعنا نحول متابعيك إلى سفراء لعلامتك التجارية من خلال حضور رقمي قوي ومؤثر.",
    },
    en: {
      headline: "Social Media Management",
      subheadline:
        "Creating an unforgettable digital presence and building communities that breathe your brand",
      content: [
      ...
      footer:
        "Let us turn your followers into brand ambassadors through a strong and influential digital presence.",
    },
  ...
  dm_marketing: {
    ar: {
      ...
      footer:
        "نحن لا نعدك بمجرد زيارات، بل نعدك بنتائج ملموسة وعائد حقيقي على الاستثمار (ROI) يضمن استدامة نجاحك وتوسع أعمالك.",
    },
    en: {
      ...
      footer:
        "We don't just promise visits; we promise tangible results and a real Return on Investment (ROI) ensuring the sustainable success and expansion of your business.",
    },
  ...
  dm_visual: {
    ar: {
      ...
      footer:
        "ارتقِ بصورتك الذهنية، واجعل من محتواك البصري أداة الجذب الأولى لجمهورك.",
    },
    en: {
      headline: "Visual Production",
      subheadline:
        "Embodying Your Identity in Images and Videos that Captivate the Senses and Make a Difference",
      content: [
      ...
      footer:
        "Elevate your brand image and make your visual content the primary attraction tool for your audience.",
    },
  ...
  dm_influencer: {
    ar: {
      ...
      footer:
        "اضمن وصول رسالتك بشكل موثوق وفعال عبر شراكات استراتيجية مع صناع الرأي في مجالك.",
    },
    en: {
      headline: "Influencer Marketing",
      subheadline:
        "Building Bridges of Trust and Credibility Through the Most Influential Voices",
      content: [
      ...
      footer:
        "Ensure your message arrives reliably and effectively through strategic partnerships with opinion leaders in your field.",
    },
  ...
  dm_content: {
    ...
    en: {
      ...
      subheadline:
        "Crafting Words that Inspire, Influence, and Drive Decision-Making",
      content: [
      ...
      footer:
        "Make every word you publish an investment that returns loyalty and profits.",
    },
  ...
  dm_exhibitions: {
    ar: {
      ...
      footer:
        "اجعل من مشاركتك القادمة حدثاً يتحدث عنه الجميع، وتجربة تترك أثراً ملموساً في مسيرة نجاحك.",
    },
    en: {
      headline: "Exhibitions & Conferences Management",
      subheadline:
        "Exceptional Organization and Live Experiences Reflecting Your Market Leadership",
      content: [
      ...
      footer:
        "Make your next participation an event everyone talks about, and an experience leaving a tangible impact on your path to success.",
    },
  ...
  dm_advertising: {
    ar: {
      ...
      subheadline:
        "استثمار ذكي للميزانيات الإعلانية لتحقيق أقصى قدر من النتائج",
      content: [
    ...
    en: {
      ...
      subheadline:
        "Smart Investment of Advertising Budgets for Maximum Results",
      content: [
      ...
      footer:
        "We turn every click into an opportunity, and every ad campaign into a profitable investment.",
    },
  ...
  dm_consultation: {
    ar: {
      ...
      footer:
        "استثمر في المعرفة، واجعل قراراتك التسويقية مبنية على رؤى خبيرة وبيانات صلبة لا مجرد تخمينات.",
    },
    en: {
      headline: "Marketing Consultation",
      subheadline:
        "Strategic Partnership and Expert Guidance to Cross Market Challenges Confidently",
      content: [
      ...
      footer:
        "Invest in knowledge, and make your marketing decisions based on expert insights and solid data, not mere guesses.",
    },
  ...
  dm_seo: {
    ar: {
      ...
      footer:
        "كن الخيار الأول والأكثر موثوقية عندما يبحث عنك العملاء، ودع نتائجك وسمعتك تتحدثان بالنيابة عنك.",
    },
    en: {
      headline: "SEO & Reputation Management",
      subheadline:
        "Top Search Results and Build an Impenetrable Fortress for Your Digital Reputation",
      content: [
      ...
      footer:
        "Be the first and most trusted choice when customers search for you, and let your results and reputation speak on your behalf.",
    },
  ...
  id_apps: {
    ar: {
      ...
      subheadline:
        "تطبيقات هواتف أصلية ومتعددة المنصات مصممة بأعلى معايير الأداء وتجربة المستخدم",
      content: [
      ...
      footer:
        "اجعل الوصول إلى خدماتك بلمسة زر، وكن الخيار الأقرب لعملائك مع تطبيق يعكس احترافيتك.",
    },
    en: {
      headline: "Apps Design & Development",
      subheadline:
        "Native and cross-platform mobile apps built to the highest performance and UX standards",
      content: [
      ...
      footer:
        "Make your services accessible with a tap, and be the closest choice for your customers with a highly professional app.",
    },
  ...
  id_website: {
    ar: {
      ...
      footer:
        "حول زوار موقعك إلى عملاء دائمين من خلال منصة رقمية تعبر عن طموحات أعمالك.",
    },
    en: {
      headline: "Website Design & Development",
      subheadline:
        "Professional websites that drive conversions and user engagement",
      content: [
      ...
      footer:
        "Turn your website visitors into loyal customers through a digital platform that reflects your business ambitions.",
    },
  ...
  id_branding: {
    ar: {
      ...
      subheadline:
        "هوية بصرية استثنائية تميزك عن المنافسين وترسخ في أذهان عملائك",
      content: [
      ...
      footer:
        "دعنا نصنع لك هوية تعبر عن قيمتك وتترك بصمة لا تُمحى في ذاكرة عملائك.",
    },
    en: {
      headline: "Branding Design & Development",
      subheadline:
        "An exceptional visual identity that distinguishes you and sticks in your customers' minds",
      content: [
      ...
      footer:
        "Let us create an identity that expresses your value and leaves an indelible mark in your customers' memory.",
    },
  ...
  id_software: {
    ar: {
      ...
      footer:
        "استثمر في تكنولوجيا مصممة خصيصاً لك، لتقود أعمالك نحو مستوى جديد من التنظيم والكفاءة.",
    },
    en: {
      headline: "Software Design & Development",
      subheadline:
        "Custom software solutions tailored to elevate efficiency and automate your operations",
      content: [
      ...
      footer:
        "Invest in technology tailored just for you, leading your business to a new level of organization and efficiency.",
    },
  ...
  id_cloud: {
    ar: {
      ...
      subheadline:
        "بنية تحتية رقمية آمنة، مرنة، وقابلة للتوسع لدعم استمرارية أعمالك",
      content: [
      ...
      footer:
        "انتقل بأعمالك إلى آفاق أوسع مع بيئة سحابية تضمن لك الأمان، المرونة، والسرعة الفائقة.",
    },
    en: {
      headline: "Cloud Services",
      subheadline:
        "Secure, flexible, and scalable digital infrastructure to support business continuity",
      content: [
      ...
      footer:
        "Take your business to broader horizons with a cloud environment that guarantees security, flexibility, and ultimate speed.",
    },
  ...
  re_appraisal: {
    ar: {
      ...
      subheadline:
        "رؤية تسويقية دقيقة مبنية على تقييم احترافي لتعظيم قيمة عقاراتك",
      content: [
      ...
      footer:
        "حقق أعلى عوائد ممكنة لعقاراتك من خلال تقييم دقيق وتسويق ذكي يصيب الهدف.",
    },
    en: {
      headline: "Real Estate Appraisal & Marketing",
      subheadline:
        "A precise marketing vision based on professional valuation to maximize your property value",
      content: [
      ...
      footer:
        "Achieve the highest possible returns for your properties through precise valuation and smart, targeted marketing.",
    },
  ...
  re_marketing: {
    ar: {
      ...
      subheadline:
        "استراتيجيات تسويق عقاري متكاملة لتسريع المبيعات وتعزيز الثقة",
      content: [
      ...
      footer:
        "تجاوز تحديات السوق العقاري وحقق أهداف مبيعاتك عبر خطط تسويقية مبنية على الأرقام والنتائج.",
    },
    en: {
      headline: "Real Estate Marketing",
      subheadline:
        "Comprehensive real estate marketing strategies to accelerate sales and build trust",
      content: [
      ...
      footer:
        "Overcome real estate market challenges and achieve your sales goals through marketing plans built on numbers and results.",
    },
  ...
  re_management: {
    ar: {
      ...
      footer:
        "ارتح من عناء الإدارة اليومية، ودع خبراءنا يضاعفون من قيمة أصولك وعوائدك الاستثمارية.",
    },
    en: {
      headline: "Property Management & Sales",
      subheadline:
        "Comprehensive professional management ensuring revenue growth and peace of mind",
      content: [
      ...
      footer:
        "Rest from the hassle of daily management, and let our experts multiply your asset value and investment returns.",
    },
  ...
  re_photography: {
    ar: {
      ...
      subheadline:
        "إبراز التفاصيل المعمارية الجمالية بصور تنبض بالحياة وتسحر المستثمرين",
      content: [
      ...
      footer:
        "التقط جوهر مشروعك بعدسات احترافية، واجعل صورك هي البائع الأول لعقاراتك.",
    },
    en: {
      headline: "Professional Photography & Representation",
      subheadline:
        "Highlighting aesthetic architectural details with lively photos that enchant investors",
      content: [
      ...
      footer:
        "Capture the essence of your project through professional lenses, and make your photos the primary seller of your properties.",
    },
  ...
  re_campaign: {
    ar: {
      ...
      footer:
        "لا تضيع ميزانيتك في إعلانات عشوائية؛ اختر استهدافاً دقيقاً يحول النقرات إلى صفقات عقارية ناجحة.",
    },
    en: {
      headline: "Advertising Campaign Management",
      subheadline:
        "Precise targeting of investors and buyers ensuring swift deal closures",
      content: [
      ...
      footer:
        "Don't waste your budget on random ads; choose precise targeting that turns clicks into successful real estate deals.",
    },
  ...
  re_project_images: {
    ar: {
      ...
      subheadline:
        "عزز قيمة مشروعك بتصاميم استثنائية وصفحات هبوط مصممة للتحويل",
      content: [
      ...
      footer:
        "ارفع من جاذبية مشروعك وقدمه للسوق بهوية بصرية فاخرة تدفع المستثمرين لاتخاذ القرار بثقة.",
    },
    en: {
      headline: "Real Estate Project Image & Landing Page Design",
      subheadline:
        "Enhance your project value with exceptional designs and conversion-focused landing pages",
      content: [
      ...
      footer:
        "Elevate your project's appeal and present it to the market with a premium visual identity that drives investors to decide confidently.",
    },
  ...
  re_current_eval: {
    ar: {
      ...
      subheadline:
        "إعادة إحياء المشاريع المتعثرة وبناء صورة ذهنية جديدة تجذب المستثمرين",
      content: [
      ...
      footer:
        "امنح مشروعك فرصة ثانية للنجاح من خلال هوية متجددة ورسائل تسويقية تصنع الفارق.",
    },
    en: {
      headline: "Current Image Evaluation & Enhancement",
      subheadline:
        "Reviving stalled projects and building a new brand image that attracts investors",
      content: [
      ...
      footer:
        "Give your project a second chance at success with a renewed identity and marketing messages that make a difference.",
    },
  ...
  re_project_naming: {
    ar: {
      ...
      footer:
        "اختر لمشروعك اسماً يعلق في الأذهان، ويكون نقطة الانطلاق الأولى نحو نجاحك التسويقي.",
    },
    en: {
      headline: "Real Estate Project Naming",
      subheadline:
        "Inventing resonant, strategic names that carry your project's story and are easy to remember",
      content: [
      ...
      footer:
        "Choose a memorable name for your project that will be the first starting point toward your marketing success.",
    },
...
export default function ServiceDetailsPage({
  ...
  if (mounted && serviceId && serviceId !== "undefined" && !serviceData) {
    console.warn(
      `Service data not found for ID: ${serviceId}. Redirecting to custom-package.`,
    );
  ...
  if (!mounted || !serviceData)
    return <div className="min-h-screen bg-[#0A0D1E]" />;

  const content =
    lang === "ar" && serviceData.ar
      ? serviceData.ar
      : serviceData.en || serviceData.ar;
                ...
                return (
                  <li key={idx} className="flex gap-4">
                    ...
                    <div>
                      {desc ? (
                        <>
                          <strong className="brand-gradient-text block mb-1 text-xl">
                            {title}:
                          </strong>
