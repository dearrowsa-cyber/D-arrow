      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {(unitPrice * item.quantity).toFixed(2)} ر.س
                  </span>
            ...
            >
              <Trash2 size={14} style={{ display: "inline", marginLeft: 6 }} />{" "}
              إفراغ السلة
            </button>
          </div>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "#E6E6EA", fontWeight: 600 }}>
            ...
            >
              <span style={{ color: "#E6E6EA", fontWeight: 700 }}>
                الإجمالي
              </span>
              <span
                style={{
