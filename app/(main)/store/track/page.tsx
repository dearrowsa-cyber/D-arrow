  ...
  const handleTrack = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        `/api/store/orders/track?orderNumber=${orderNumber}&email=${email}`,
      );
      ...
      if (data.success) {
        ...
        setError(
          data.error || "لم يتم العثور على الطلب. تأكد من البيانات المدخلة.",
        );
        setOrder(null);
      }
    } catch (err) {
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ color: "#9CA3AF", fontSize: 18 }}>
            أدخل رقم الطلب والبريد الإلكتروني لمتابعة حالة طلبك والحصول على
            بيانات الخدمة.
          </p>
        </div>
                ...
                {order.items.map((item: any) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        <div style={{ color: "#E6E6EA", fontWeight: 600 }}>
                          {item.productName}
                        </div>
