  ...
  const cart =
    cartItems && cartItems.length > 0
      ? cartItems.map((item) => ({
          ...
          image:
            item.image ||
            "https://images.unsplash.com/photo-1556742049-0a67c5574f73?auto=format&fit=crop&w=200&q=80",
  ...
  return (
    ...
    >
      ...
      {step !== "processing" && step !== "confirmed" && (
        <div
          style={{ maxWidth: 700, margin: "24px auto 0", padding: "0 24px" }}
        >
          <div
            style={{
              display: "flex",
      ...
      <div
        style={{ maxWidth: 1100, margin: "28px auto 60px", padding: "0 24px" }}
      >
        <div
          style={{
            display: "grid",
          ...
          <div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        <span style={{ color: "#6B7280" }}>المدينة والحي:</span>{" "}
                        {shipping.city} — {shipping.district}
                      </div>
                      <div>
                        <span style={{ color: "#6B7280" }}>الشارع:</span>{" "}
                        {shipping.street}
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      أوافق على الشروط والأحكام و سياسة الاسترجاع والشحن
            ...
            {step === "processing" && (
              ...
              >
                ...
                <p
                  style={{ fontSize: 14, color: "#9CA3AF", margin: "0 0 32px" }}
                >
                  يرجى عدم إغلاق الصفحة — الاتصال بالبنك السعودي مباشر 🇸🇦
                </p>
            ...
            {step === "confirmed" && (
              ...
              >
                ...
                <p
                  style={{ fontSize: 14, color: "#9CA3AF", margin: "0 0 28px" }}
                >
                  تم إرسال تفاصيل الفاتورة الإلكترونية إلى جوالك وصندوق البريد
                  الإلكتروني.
                </p>
                ...
                >
                  ...
                  >
                    ...
                    {copiedOrderId ? "تم النسخ" : "نسخ الرقم"}
                  </button>
                </div>
          ...
          {step !== "processing" && step !== "confirmed" && (
            ...
            >
              ...
              >
                ...
                >
                  <Package size={18} style={{ color: "#FF4D6D" }} /> ملخص
                  الفاتورة ({totalItems})
                </h3>
              </div>
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{
                      color: shippingCost === 0 ? "#10B981" : "white",
                      fontWeight: 600,
                    }}
                  >
